...
<body>
    ...
    <h2>Inserir Novo Livro (Vulnerável)</h2><a href="part3_postbook.php"> Visitar formulário
        correto</a>
    <a href="part3.php">Voltar para a parte 3</a>
    <form action="part3_insert_book_vulnerable.php" method="post">
        <table border="1">
            <thead>
                <tr>
